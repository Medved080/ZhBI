...
const KIND_TEXT = { counterparty: ["контрагента", "контрагентом"], agreement: ["договор", "договором"], specification: ["спецификацию", "спецификацией"], mark: ["марку", "маркой"], zone: ["зону", "зоной"], subtype: ["подтип", "подтипом"] };

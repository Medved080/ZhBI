...
//
// Устройство: рабочее место (workspace.js, ws === "model" | "foreman" — только там есть эта модель фильтра,
// у МФР и комплектовщика свой отбор с другим смыслом) при КАЖДОЙ смене модели фильтра просит у кадра актуальный
...
// payload: { objectId, ws: "model"|"foreman", elementIds: number[], shown, total, excluded, capturedAt }
...
const wsLabel = { model: "«Модель»", foreman: "«Прораб»" };

...
FIELD_LABELS = {
    ...
    # Комментарий в EDITABLE_FIELDS не входит (порог у него свой, см. PATCH
    # /elements/{id}/comment), но подпись нужна здесь же: массовая правка
    # через Excel показывает его в сводке расхождений наравне с остальным, а
    # вторая подпись в другом файле разъехалась бы с этой. Тот же случай, что
    # у `contract_id`.
    "comment": "Комментарий",
}

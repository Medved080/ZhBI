...
#
# Знак у отметки НЕОБЯЗАТЕЛЕН: первый этаж записан как
# `С01-02_1_этаж_основной_0.000` — ноль без плюса. С обязательным знаком
# это имя не разбиралось вовсе, уровень выпадал из справочника, а его
# элементы уходили в «без этажа».

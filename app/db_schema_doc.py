...
("object_external_models", "object_external_models — Внешние 3D-модели объекта (благоустройство и т.п.)", C_HIER, S_HIER, [
    ...
    ("source_anchor_x_mm", "REAL", "", "X центра габарита модели — РЕАЛЬНАЯ абсолютная координата из самого FBX (не привязана к объекту), мм. Итоговая позиция = source_anchor + offset"),
    ("source_anchor_y_mm", "REAL", "", "Y центра габарита модели, реальная абсолютная координата из FBX, мм"),
    ("source_anchor_z_mm", "REAL", "", "Z центра габарита модели, реальная абсолютная координата из FBX, мм"),
    ("object_anchor_x_mm", "REAL", "", "X центра горизонтального габарита ВСЕГО объекта на момент загрузки/сброса — информационное поле, на позиционирование модели НЕ влияет (отменено 2026-09-11: FBX уже несёт настоящие координаты площадки)"),
    ("object_anchor_y_mm", "REAL", "", "Y центра горизонтального габарита объекта — информационное поле, см. object_anchor_x_mm"),
    ("centering_revision", "TEXT", "", "ревизия/хэш габарита объекта на момент последнего upload/recenter — информационное поле, см. object_anchor_x_mm"),
    ("offset_x_mm", "REAL", "", "ручной сдвиг по X поверх source_anchor (реальных координат из файла), мм"),
    ("offset_y_mm", "REAL", "", "ручной сдвиг по Y поверх source_anchor, мм"),
    ("offset_z_mm", "REAL", "", "ручной сдвиг по высоте (Z) поверх source_anchor, мм; 0 = положение как в файле"),

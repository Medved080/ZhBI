...
("users", "users — Пользователи", C_USER, S_USER, [
    ...
    ("recent_objects", "TEXT", "", "не используется (группа «Недавние» в поповере тулбара убрана 2026-09-08); столбец не заполняется, старые значения не читаются"),

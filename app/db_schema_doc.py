...
("blocks", "blocks — Блок (секция × этаж)", C_ELEM, S_ELEM, [
    ...
    ("work_types_configured_at", "TEXT", "", "отбор операций «эт/сек» для блока настраивали хоть раз (app/work_fact.py); NULL — отбор ещё = весь список операций «эт/сек» объекта"),
...
("block_work_types", "block_work_types — Отбор операций «эт/сек» на блоке", C_ELEM, S_ELEM, [
    ("block_id", "INTEGER", "PK,FK", "блок → blocks.id (CASCADE)"),
    ("work_type_id", "INTEGER", "PK,FK", "операция → work_types.id (CASCADE); наличие строки = операция включена в отбор блока"),
]),
...
FKS = [
    ...
    ("block_work_types", "block_id", "blocks", "id", "CASCADE"),
    ("block_work_types", "work_type_id", "work_types", "id", "CASCADE"),

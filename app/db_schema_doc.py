...
("objects", "objects — Объект (здание)", C_HIER, S_HIER, [
    ...
    ("smu", "TEXT", "", "подразделение (СМУ, дивизион); «Не требуется» — осмысленное значение, не пропуск"),
    ("smu_director", "TEXT", "", "директор подразделения, ФИО строкой"),
    ("responsible", "TEXT", "", "ответственный по объекту (ДП/РП), ФИО строкой"),

...
Добавить поштучный учет панелей облицовки шахт подъемников ГП1/ГП2 внутри существующего объекта ЖБИ «Москвич»: распознать марку и контур, вычислить сторону/координаты/отметки, показать изделия на общей модели, применять обычные статусы и контрактацию сервиса.

  ...
  },
  {
    ...
    async run(t) {
      ...
      for (const [m, p, b] of [
        ...
        ["POST", "/specifications", { agreement_id: 2, number: "С-1", specification_date: null }], ["PATCH", "/specifications/3", { agreement_id: 2, number: "С-1", expected_version: "ab" }],
        ["POST", "/contracts", { specification_id: 3, theme: null, is_archived: false, lines: [{ element_type: "Колонна", mark: "К1", quantity: 3 }], incidents: [], capacity: [] }],
        ["PATCH", "/contracts/4", { specification_id: 3, theme: "т", is_archived: false, lines: [{ element_type: "Колонна", mark: null, quantity: 0 }], expected_version: "ab" }],
        ["PATCH", "/elements/1/planned-delivery-date", { planned_delivery_date: "2026-12-01" }], ["PATCH", "/elements/1/planned-delivery-date", { planned_delivery_date: null }],
        ["POST", "/dictionaries/counterparty/1/delete", { replacements: { "counterparty:1": "2" }, mode: "replace" }], ["POST", "/dictionaries/contract/1/delete", { replacements: {}, mode: "replace" }],
        ["POST", "/supplier-changes", { object_id: 1, kind: "supplier_change", doc_date: "2026-09-21", from_contract_id: 1, to_contract_id: 2, element_ids: [5] }],
        ["PATCH", "/supplier-changes/3", { object_id: 1, kind: "link_swap", doc_date: "2026-09-21", from_contract_id: 1, to_contract_id: 2, mark: "К1", side_a: [5], side_b: [6], expected_version: "ab" }],
      ...
      for (const [m, p, b] of [
        ...
        ["POST", "/contracts", { specification_id: 3, lines: [{ element_type: "А", mark: "Б", quantity: 1 }, { element_type: "а", mark: "б", quantity: 2 }] }],
